...
public class Function {
    ...
    public static void snackBarRed(Context context, String str) {
        ...
        ((TextView) view.findViewById(com.epoool.transport.R.id.snackbar_text)).setTextColor(-1);
        snackbarMake.show();
    }

    public static void openAct(Context context) {
        ((Activity) context).overridePendingTransition(com.epoool.transport.R.anim.pull_in_right, com.epoool.transport.R.anim.push_out_left);
    }

    public static void closeAct(Context context) {
        ((Activity) context).overridePendingTransition(com.epoool.transport.R.anim.pull_in_left, com.epoool.transport.R.anim.push_out_right);
    }
